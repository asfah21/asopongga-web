    ...
    return (
        <MainLayout header="Certificates">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <Link href={route('certificates.create')} className="ml-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
