        ...
        <FrontLayout>
            ...
            <div className="relative bg-indigo-900 overflow-hidden">
                        ...
                        <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                            <div className="sm:text-center lg:text-left">
                                <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                                    ...
                                    <span className="block text-indigo-400 xl:inline">experiences</span>
                                </h1>
                                ...
                                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                                    ...
                                    <div className="mt-3 sm:mt-0 sm:ml-3">
                                        <div className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-800 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10">
                                            Contact Us
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                    ...
                    <div className="h-56 w-full bg-indigo-800 sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center">
                        <svg className="w-1/3 h-1/3 text-indigo-600 opacity-50" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z" /></svg>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-gray-50 py-16">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mt-10 text-center">
                            <Link href={route('blog.index')} className="text-indigo-600 font-semibold hover:text-indigo-500">
                                View all posts &rarr;
                            </Link>
                        </div>
                    </div>
